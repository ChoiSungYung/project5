...
<%
	...
	String p_num = request.getParameter("id");	
...
%>
	...
	<div class="wrap">
	<h3 class="pop_tit">상품코드 중복</h3>
	<p>중복된 상품코드가 존재합니다.</p>
	<button onclick ="location.href= codeCheckForm.jsp'" class="inbtn">다시 입력하기</button>
	</div>
...
%>
	<div class="wrap">
	<h3 class="pop_tit">상품코드 중복 확인 완료</h3>
	<p><%=p_num%>는 사용 가능한 코드입니다.</p>
	<p><span style="color:red">적용하기</span>를 누르시면 입력하신 코드를 사용할 수 있습니다.</p>
	<button onclick ="javascript:apply('<%=p_num%>')" class="inbtn">적용하기</button>
	</div>
	</body>
	<script>
	function apply(id){
		//opener 부모창
		opener.document.pform.p_num.value=id;
