...
<body>
	<div class="wrap">
		...
		<form action="codeCheckPro.jsp" method="post" onsubmit="return invaildCheck(this)">
			<div class="item_fr">
		...
		function invaildCheck(f){
			var id = f.id.value;
			id = id.trim();
			if(id.length1<0 || id.length>12){
				alert("코드는 글자수가 8이상~12이하 이어야 합니다.")
				return false;
			}
		}
		</script>
