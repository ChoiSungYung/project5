...
<%
	...
	try {
		...
		if(n>=1){
			//상품등록 성공시 이동
			out.println("<script>alert('상품이 등록되었습니다'); location.href='insertProduct.jsp';</script>");
		} else {
			//상품등록 실패시 이동
			out.println("<script>alert('상품이 등록이 거부되었습니다'); location.href='insertProduct.jsp';</script>");
		}
